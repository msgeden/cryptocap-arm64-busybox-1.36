...
int main(void)
{
    ...
    printf("App: PID: %d\n", app_pid);
    printf("App: Received PC=0x%lx, SP=0x%lx, TTBR0_EL1=0x%lx, TTBR1_EL1=0x%lx, CURRENT_TASK_STRUCT=0x%lx, PSTATE=0x%lx, TPIDR_EL0=0x%lx, TPIDRRO_EL0=0x%lx\n", lib1_process_cap.PC,  lib1_process_cap.SP_EL0, lib1_process_cap.TTBR0_EL1, lib1_process_cap.TTBR1_EL1, lib1_process_cap.TASK_STRUCT, lib1_process_cap.PSTATE, lib1_process_cap.TPIDR_EL0, lib1_process_cap.TPIDRRO_EL0);
