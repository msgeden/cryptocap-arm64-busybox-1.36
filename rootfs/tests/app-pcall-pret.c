...
int main(void)
{
    ...
    //     : "r"(lib1_process_cap.PID), "r"(lib1_process_cap.PC), "r"(lib1_process_cap.MAC) // Input operands
    //     : "x0", "x1", "x2", "memory" // Clobbered registers
    // );
    sum=syscall(SYS_pcall, lib1_process_cap.PID, lib1_process_cap.PC, lib1_process_cap.MAC);
